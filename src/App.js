...
<div style={{ display: "flex", alignItems: "center", gap: 160, flexWrap: "wrap", maxWidth: "100%" }}>
 <img src="/logo-new.svg" alt="INTrouble" style={{ height: 85, borderRadius: 6 }} />
  ...
  <div style={{ display: "flex", alignItems: "center", gap: 80 }}>
    <div>
      <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 26, letterSpacing: 2, color: "#f59e0b" }}>{t.appName}</div>
